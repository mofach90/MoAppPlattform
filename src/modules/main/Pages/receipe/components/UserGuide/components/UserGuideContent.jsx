...
const UserGuideContent = ({ currentStep, slideIn }) => (
  <DialogContent
    dividers
    sx={{
      padding: 3,
  ...
  >
    <animated.div style={slideIn}>
      <Box display="flex" flexDirection="column" alignItems="center">
        ...
        <Typography variant="h6" sx={{ fontWeight: 'bold', fontSize: '2.3rem', mb: 5 }}>
